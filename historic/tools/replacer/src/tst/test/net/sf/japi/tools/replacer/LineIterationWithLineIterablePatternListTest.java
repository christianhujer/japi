 ...
 */
public class LineIterationWithLineIterablePatternListTest extends LineIterationTestCase {

    /** {@inheritDoc} */
    @Override
    public Iterator<CharSequence> createIterator(@NotNull final CharSequence text) {
        return new LineIterable(text, LineIterable.IteratorImplementation.PATTERN_LIST).iterator();
    }
