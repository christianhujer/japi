 ...
 */
public class LineIterationWithLineIterableSplitIteratorTest extends LineIterationTestCase {

    /** {@inheritDoc} */
    @Override
    public Iterator<CharSequence> createIterator(@NotNull final CharSequence text) {
        return new LineIterable(text, LineIterable.IteratorImplementation.SPLIT_ITERATOR).iterator();
    }
